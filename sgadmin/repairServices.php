...
<head>
    ...
    <link rel="stylesheet" href="assets/css/repairServices.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <span class="navText">Repair Services Details</span>
            <!-- Button trigger modal -->
            <button type="button" class="addRepSerBtn" data-bs-toggle="modal" data-bs-target="#add-Rep-Ser-modal">
    ...
    <div class="modal fade" id="add-Rep-Ser-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Repair Services</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="submitData/newRepSer.php" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="repSerName" class="form-label">Name</label>
                            <input type="text" name="name" class="form-control" id="repSerName" placeholder="Enter Full Name" required>
                        </div>
                        <div class="mb-3">
                            <label for="repSerMobile" class="form-label">Mobile</label>
                            <input type="number" name="mobile" min="1111111111" max="9999999999" maxlength="10" class="form-control" id="repSerMobile" placeholder="Enter Mobile Number" required>
                        </div>
                        <div class="mb-3">
                            <label for="repSerRole" class="form-label">Role</label>
                            <input type="text" name="role" class="form-control" id="repSerRole" placeholder="Enter Role or Profession" required>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <input type="submit" name="submitRepSerBtn" class="submitRepSerBtn" value="Submit">
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="card allRepSerCard" id="searchItems">
            ...
            <div class="card-body">
                ...
                <div class="operationBtn">
                    <form action="submitData/deleteRepSer.php" method="POST">
                        <input type="hidden" name="repSerId" value="<?php echo $repSerRow['id'];?>">
                        <button type="submit" name="deleteRepSerBtn" class="btn btn-danger btn-delete-staff"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>
                    </form>
                </div>
            </div>
        </div>
